        ...
        body: BlocBuilder<OrderBloc,OrderState>(
          builder: (context,state){
            if(state is OrderLoading){
              ...
              return state.data.isEmpty?const Center(child:Text('Data belum ada')): Padding(
                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text('${order.jam}/${getDateDashboard(order.tanggal)}'),
                        ],
                      ),
                      trailing: Chip(label: Text(order.statusOrder[0].status),),
                      onTap: (){
